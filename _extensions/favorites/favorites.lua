...
function Pandoc(doc)
  ...
  if quarto.doc.is_format("html") then
    ...
    -- Check if favorites button should be excluded on this page
    local exclude_favorites_button = doc.meta.no_favorites_button

    -- Only add the favorites button if not explicitly excluded
    if not exclude_favorites_button then
      -- Create button HTML
